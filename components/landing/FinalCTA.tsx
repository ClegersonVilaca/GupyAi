    ...
    return (
        <section className="py-20 bg-primary text-white">
            <div className="mx-auto max-w-4xl px-4 text-center">
                ...
                <button className="inline-flex items-center justify-center gap-2 rounded-xl bg-accent-success px-8 py-4 text-base font-bold text-white shadow-lg hover:brightness-110 hover:-translate-y-0.5 transition-all duration-200">
